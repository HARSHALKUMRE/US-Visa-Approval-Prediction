    ...
    def is_Validation_successfull(self):
        try:
            ...
            if self.isFolderPathAvailable() == True:
                ...
                is_train_column_name_same = self.train_data.check_columns_names()

                is_train_missing_values_whole_column = self.train_data.missing_value_whole_column()

                self.train_data.replace_missing_value_with_null()
                ...
                is_test_column_name_same = self.test_data.check_columns_names()

                is_test_missing_values_whole_column = self.test_data.missing_value_whole_column()

                self.test_data.replace_missing_value_with_null()
