...
from visa.utils.main_utils import load_numpy_array_data, save_object, load_object
...
class VisaApprovalPredictor:
    ...
    # 0.5   < REJECTED
    # PROBABILITY FOR THE PARTICULAR CLASS ( ACCPEDTED OR REJECTED )
    ...
    # bATCH PREDICTION ->UPLOAD -> GET VALIDATION -> DATA TRSNAFORMTION -> MODEL FILE
